...
import { setCity, getCurrentCity } from '../../utils/city'
...
class CityList extends Component {
  ...
  async getCityListData() {
    ...
    // 4、处理定位城市
    cityIndex.unshift('#')
    // city : {label:'深圳',value:'AREA|a6649a11-be98-b150'}
          ...
          <AutoSizer>
            {({ height, width }) => (
              <List
                ...
                height={height} // 整个List组件的高度，高度很重要，如果是0，则不渲染每一行
                rowCount={cityIndex.length} // 显示多少条数据
                rowHeight={this.calcRowHeight} // 每一条数据高度
